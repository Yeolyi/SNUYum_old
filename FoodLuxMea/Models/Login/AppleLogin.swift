...
final class SignInWithAppleToFirebase: UIViewControllerRepresentable {
    ...
    func startSignInWithAppleFlow() {
        ...
        appleSignInDelegates = SignInWithAppleDelegates(window: nil, currentNonce: nonce, onLoginEvent: self.onLoginEvent)
...
class SignInWithAppleDelegates: NSObject {
    ...
    init(window: UIWindow?, currentNonce: String, onLoginEvent: @escaping ((SignInWithAppleToFirebaseResponse) -> Void)) {
        self.window = window
